...
if __name__ == "__main__":
    ...
    (0, {"age" : 25, "comp" : "inf"}), (100, {"age" : 50, "emploi" : "santé", "comp" : "inf"}), (108, {"age" : 50, "emploi" : "médico-social", "comp" : "inf"}),
    (115, {"age" : 85, "comp" : "sup"}), (120, {"age" : 40, "comp" : "inf"}), (150, {"age" : 60, "comp" : "inf"}), (212, {"age" : 60, "comp" : "sup"})
    ])
    init = SituationInitiale()
    param = Parametres(
        simulation_duree=500,infection_proba=0.0065, multiplicateur_distance=1, deces_proba=0.001
    )
